...
function aplicarEstilosDescricaoItem() {
    ...
    style.innerHTML = `
        /* Overlay com z-index maior para sobrepor o modal da mochila */
        .modal-descricao-overlay {
            ...
            align-items: center;
            z-index: 10000; /* Maior que os 9999 da mochila */
        }
...
export function abrirModalDescricaoItem(objeto, imgSrc) {
            ...
            <div class="modal-descricao-body">
                <div class="modal-descricao-top">
                    ...
                    <div class="modal-descricao-info">
                        ...
                        <div><strong>Compra:</strong>  ${objeto.valor_de_compra ?? 0}</div>
    ...
    // Evento de fechar ao clicar no botão 'X' ou fora do modal
