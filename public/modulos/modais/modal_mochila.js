...
export async function abrirModalMochila() {
    ...
    for (let i = 0; i < 20; i++) {
        ...
        if (itemNoSlot) {
            ...
            slotsHtml += `
                <div class="slot-mochila com-item" data-slot="${i}">
    ...
    slotsComItem.forEach(slotEl => {
        slotEl.onclick = () => {
            ...
            const itemClicado = itensMochila.find(m => m.slot_index === slotIndex);
            ...
            if (itemClicado && itemClicado.objetos) {
                ...
                abrirModalDescricaoItem(itemClicado.objetos, imgSrc);
            }
        };
    });
